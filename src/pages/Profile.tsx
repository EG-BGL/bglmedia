    ...
    <Layout hideFooter>
      <div className="page-container py-4 max-w-lg mx-auto space-y-4">
        ...
        <div className="flex gap-2">
          <Dialog open={editOpen} onOpenChange={setEditOpen}>
            <DialogTrigger asChild>
              <Button variant="outline" size="sm" className="rounded-full font-bold gap-1.5 flex-1">
          ...
          <Button variant="destructive" size="sm" onClick={handleSignOut} className="rounded-full font-bold gap-1.5 flex-1">
